...
def main():
    ...
    matriz_ass_input = calcula_assinatura(texto)
...
def le_assinatura():
    #A funcao le os valores dos tracos linguisticos do modelo e devolve umaassinatura a ser comparada com os textos fornecidos.
...
def avalia_textos(textos_main, ass_comparadas):
    #Essa funcao recebe uma lista de textos e deve devolver o numero (0 a n-1) do texto com maior probabilidade de ter sido infectado por COH-PIAH.
   
