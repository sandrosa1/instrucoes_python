...
def calcula_assinatura(texto):
    ...
    meia_palavras = soma_palavra/len(palavras)
    relacao_type_token = n_palavras_diferentes(palavras)/len(palavras)
    hapax_legomana = n_palavras_unicas(palavras)/len(palavras)
    meio_sentencas = soma_caracter_sentenca / len(sentencas)
    complexidade_sentenca = len(frases) / len(sentencas)
    tamanho_meio_frase = soma_caracter_frase / len(frases)

    return [meia_palavras, relacao_type_token, hapax_legomana, meio_sentencas, complexidade_sentenca, tamanho_meio_frase]
